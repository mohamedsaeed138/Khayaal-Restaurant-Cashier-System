...
using Khayaal.Main_Form_and_Children_Forms_AR.Bills_Form_and_Mdi_Forms_AR;
using Khayaal.Main_Form_and_Children_Forms_AR.Booking_Form_and_Mdi_Forms_AR;
using Khayaal.Main_Form_and_Children_Forms_AR.Home_Form_and_Mdi_Forms_AR;
using Khayaal.Main_Form_and_Children_Forms_AR.Purchases_Form_and_Mdi_Forms_AR;
using Khayaal.Main_Form_and_Children_Forms_AR.Raw_Materials_Form_and_Mdi_Forms_AR;
using Khayaal.Main_Form_and_Children_Forms_AR.Relations_Form_and_Mdi_Forms_AR;
using Khayaal.Main_Form_and_Children_Forms.Credit_Form;
using Khayaal.Properties;

namespace Khayaal.Main_Form_and_Children_Forms_AR
{
