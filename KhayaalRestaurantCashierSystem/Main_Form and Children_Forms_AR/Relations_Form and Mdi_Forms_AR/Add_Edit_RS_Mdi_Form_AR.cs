...
{
    public partial class Add_Edit_RS_Mdi_Form_AR : Form
    {
        int id;
        bool Add = true;
        ...
        public Add_Edit_RS_Mdi_Form_AR()
        {
            Reload();
        }
        public Add_Edit_RS_Mdi_Form_AR(string item, string raw, string qty, int id)
        {
            Add = false;
            Reload();
            this.id = id;
        ...
        private void Add_Relation_Button_Click(object sender, EventArgs e)
        {
            ...
            {
                string item = Formatter.SpecialFormatting(Item_Combo_Box.Text);
                string raw = Formatter.SpecialFormatting(Raw_Combo_Box.Text);
