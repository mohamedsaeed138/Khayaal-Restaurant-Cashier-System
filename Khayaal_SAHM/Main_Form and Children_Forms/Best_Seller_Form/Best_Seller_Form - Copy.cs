...
{
    public partial class Best_Seller_Form_Copy : Form
    {
        static SqlConnection conn = new SqlConnection(Connection_String.Value);
        public Best_Seller_Form_Copy()
        {
            InitializeComponent();
            Fill_Combo_Box();
            Fill_Table();
        ...
        private void Search_Text_Box_TextChanged(object sender, System.EventArgs e)
        {
            Fill_Table(Search_Text_Box.Text, Category_Combo_Box.SelectedText, dateTimePicker1.ToString(), dateTimePicker2.ToString());
        }
    }
}
